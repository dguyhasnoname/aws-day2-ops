        ...
        for page in page_iterator:
            ...
            for x in page['Volumes']:
                ...
                try:
                    ...
                    pass
                if cluster in name:
                    cluster_volume.append([volume_id, name, x['State'], x['Encrypted'], device, delete_condition])
                else:
                    all_volumes.append([volume_id, name, x['State'], x['Encrypted'], device, delete_condition])
        if cluster_volume:
